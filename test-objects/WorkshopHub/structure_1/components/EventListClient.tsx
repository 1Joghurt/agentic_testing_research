  ...
  return (
    <>
      ...
      {visibleOwnEvents.length > 0 && (
        <section className="mt-10 border-t pt-8" aria-labelledby="managed-workshops-heading">
          <div className="mb-4">
            <h2 id="managed-workshops-heading" className="text-xl font-semibold tracking-tight">
              Your Workshops
            </h2>
          </div>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
